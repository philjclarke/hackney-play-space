...
if ( ! class_exists( 'UM_Gallery_Pro_Template' ) ) :
	...
	class UM_Gallery_Pro_Template {
		...
		public function hooks() {
			...
			// Album form fields
			add_action( 'um_gallery_pro_album_form_fields_top', array( $this, 'um_gallery_pro_album_form_fields_album_name' ), 1, 1 );
			add_action( 'um_gallery_pro_album_form_fields_top', array( $this, 'um_gallery_pro_album_form_fields_album_descritpion' ), 6, 1 );
			add_action( 'um_gallery_pro_album_form_fields_bottom', array( $this, 'um_gallery_pro_album_form_fields_album_privacy' ), 1, 1 );
		}

		public function um_gallery_pro_album_form_fields_album_name( $album = array() ) {
			?>
		...
		public function um_gallery_pro_album_form_fields_album_descritpion( $album = array() ) {
			?>
			<div class="um-gallery-form-field">
		...
		public function um_gallery_pro_album_form_fields_album_privacy( $album = array() ) {
			?>
			<div class="um-gallery-form-field">
