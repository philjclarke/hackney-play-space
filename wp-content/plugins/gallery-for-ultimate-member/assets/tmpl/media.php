<div id="um-gallery-modal" class="um-gallery-popup" data-id="{{media_id}}">
	...
	<div class="um-user-gallery-right">
		<div class="um-user-gallery-right-inner">
			...
			<div class="um-user-gallery-info">
				...
				<?php //error_log( __LINE__  . '   ' . um_gallery()->is_owner() ); ?>
				<?php //if ( um_gallery()->is_owner() ) { ?> 
					<?php if ( is_user_logged_in() ) { ?>
					{{#if is_owner}}
					<div class="um-user-gallery-modify">
					 ...
					 <div class="um-gallery-caption-edit-wrapper" data-id="{{media_id}}"><a href="#" id="um-gallery-caption-edit" data-id="{{media_id}}"><?php _e( '<i class="um-faicon-pencil"></i> Edit', 'gallery-for-ultimate-member' ); ?></a></div>
					 {{/if}}
					 <?php } ?>
				<?php //} ?>
			</div>
