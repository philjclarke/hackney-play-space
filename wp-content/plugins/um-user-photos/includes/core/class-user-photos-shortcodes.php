...
class User_Photos_Shortcodes {
	...
	function wp_enqueue_scripts() {
		...
		wp_register_style( 'um-user-photos', um_user_photos_url . 'assets/css/um-user-photos' . $suffix . '.css', array( 'um-images-grid', 'um_ui' ), um_user_photos_version );
		...
		wp_register_script( 'um-user-photos', um_user_photos_url . 'assets/js/um-user-photos' . $suffix . '.js', array( 'wp-util', 'um-images-grid', 'jquery-ui-sortable' ), um_user_photos_version, true );
	...
	function get_gallery_content( $atts = array() ) {
		...
		if( um_is_myprofile() || $is_my_profile ) {
			...
			UM()->Photos_API()->shortcodes()->modal_template();
		}
