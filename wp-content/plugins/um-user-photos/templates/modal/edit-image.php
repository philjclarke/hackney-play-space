...
<div class="um-form">
	<form method="post" action="<?php echo esc_url( admin_url( 'admin-ajax.php?action=update_um_user_photos_image' ) ); ?>" enctype="multipart/form-data">
		...
		<div class="um-field">
			<label for="image-title-<?php echo esc_attr( $photo->ID ); ?>"><?php _e( 'Image title', 'um-user-photos' ); ?></label>
		...
		<div class="um-field">
			<label for="image-caption-<?php echo esc_attr( $photo->ID ); ?>"><?php _e( 'Image caption', 'um-user-photos' ); ?></label>
		...
		<div class="um-field">
			<label for="image-link-<?php echo esc_attr( $photo->ID ); ?>"><?php _e( 'Related link', 'um-user-photos' ); ?></label>
