	...
	<div class="um-form" data-mode="<?php echo esc_attr( $mode ) ?>">
		...
		<div class="um-profile-navbar <?php echo esc_attr( $classes ); ?>">
			...
			<div class="um-clear"></div>
				...
				<p>On these pages you can <a href="/user/?um_action=edit">add information about yourself</a> as well as <a href="/user/?profiletab=gallery">add images and videos</a> to build your portfolio.<br />
				You can also <a href="/user/?profiletab=project">add more information about your project here</a>.</p>
