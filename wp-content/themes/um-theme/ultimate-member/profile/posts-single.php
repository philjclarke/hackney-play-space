...
<div class="boot-row um-tab-post-single">
	...
	<div class="boot-col-md-8 um-tab-post-content">
		...
		<div class="um-item-link">
			<h4><a href="<?php echo get_permalink( $post ) ?>"><?php echo get_the_title( $post ); ?></a></h4>
		</div>

		<div class="um-item-meta">
			<span><?php printf( __( '%s ago', 'um-theme' ), human_time_diff( get_the_time( 'U', $post->ID ), current_time( 'timestamp' ) ) ); ?></span>
			<span><?php echo __( 'in', 'um-theme' ); ?>: <?php the_category( ', ', '', $post->ID ); ?></span>
			<span><a href="<?php echo get_comments_link( $post->ID ) ?>"><?php echo $comments; ?></a></span>
		</div>
