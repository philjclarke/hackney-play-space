...
(function($) {
    ...
    var menu_color = $('.header-profile-section .profile-menu-wrapper a,.um-header-avatar-name a,#bs-navbar-profile a,#bs-navbar-primary a,#bs-navbar-primary'),
    ...
    wp.customize('customization[title_text_color]', function (value) {
        value.bind(function (updatedValue) {
            let headingSelector = document.querySelectorAll('h1, h2, h3, h4, h5, h6');
            if (null !== headingSelector) {
                headingSelector.forEach((heading) => {
                    heading.style.color = updatedValue;
                })
            }
        })
    });
    ...
    wp.customize('customization[um_theme_logo_hover_color]', function (value) {
        value.bind(function (updatedValue) {
            let logoColorHover = document.querySelector('.site-title a:hover');
            if (null !== logoColorHover) {
                logoColorHover.style.color = updatedValue;
            }
        })
    }); 
    ...
    wp.customize('customization[um_theme_website_meta_color]', function(value) {
        value.bind(function(updatedValue) {
            let metaColor = document.querySelectorAll('.single.post-meta,.single.post-meta a,.comment-reply-link,.comment__author,.post-meta__author,.comment-edit-link, .adverts-single-author-name, .meta, .post-meta__time');
            if (null !== metaColor){
                metaColor.forEach((meta) => {
                    meta.style.color = updatedValue;
                })
            }
        });
    });
    ...
    wp.customize('customization[button_background_color]', function(value) {
        value.bind(function(updatedValue) {
            let btnBgColor = document.querySelectorAll('.comment-form input[type=submit],.site-search form input[type=submit]');
            if (null !== btnBgColor){
                btnBgColor.forEach((button) => {
                    button.style.backgroundColor = updatedValue;
                })
            }
        });
    });
    ...
    wp.customize('customization[um_theme_submenu_text_color]', function(value) {
        value.bind(function(newval) {
            $('.dropdown-item,.header-profile-section .profile-menu-wrapper a').css('color', newval);
        });
    });
    ...
    wp.customize('customization[header_search_placeholder_text_color]', function(value) {
        value.bind(function(newval) {
            $('.header__wrapper .search-form ::placeholder').css('color', newval);
        });
    });
    ...
    wp.customize('customization[um_post_single_box_bg]', function(value) {
        value.bind(function(newval) {
            $('.s-post__content').css('background-color', newval);
        });
    });
    ...
    wp.customize('customization[um_post_single_box_text_color]', function(value) {
        value.bind(function(newval) {
            $('.s-post__content').css('color', newval);
        });
    });
    ...
    wp.customize('customization[header_private_message_color]', function(value) {
        value.bind(function(newval) {
            $('.header__user-account .um-notification-m').css('color', newval);
        });
    });
    ...
    wp.customize('customization[header_notification_color]', function(value) {
        value.bind(function(newval) {
            $('.header__user-account .um-notification-b').css('color', newval);
        });
    });
    ...
    wp.customize('customization[um_theme_ext_reviews_single_title_color]', function(value) {
        value.bind(function(newval) {
            $('div.um .um-form div.um-reviews-post__content .um-reviews-title').css('color', newval);
        });
    });
