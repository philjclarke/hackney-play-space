...
if ( ! function_exists( 'um_theme_header_menu' ) ) {
    function um_theme_header_menu() {
        ...
        if ( function_exists('max_mega_menu_is_enabled') && max_mega_menu_is_enabled('primary') ) {
            ...
            <nav class="<?php echo apply_filters('um_header_nav_css_class', "navbar navbar-expand-xl navbar-expand-md navbar-light");?>" aria-label="<?php esc_attr_e( 'Primary Menu', 'um-theme' ); ?>">
...
?>
        ...
        <div class="boot-row boot-align-items-center">
            ...
            <?php if ( 1 === (int) $header_layout ) : ?>
                ...
                <div class="header__user-account <?php echo $position_class;?> boot-col-5 boot-col-sm-5 boot-col-md-3 boot-order-3 boot-order-md-4 boot-text-right">
                    <?php
            ...
            <?php if( 2 === (int) $header_layout ) : ?>
                ...
                <div class="header__user-account <?php echo $position_class;?> boot-col-md-2 boot-col-8 boot-order-3 boot-order-md-4 boot-text-right">
                    <?php
                        do_action( 'um_theme_header_profile_before' );
            ...
            <?php if ( 3 === (int) $header_layout ) : ?>

                <div class="header__search search-position-left boot-col-md-3 boot-col-12 boot-order-md-1 boot-order-4">
                    <?php um_theme_display_header_search();?>
                </div>

                <div class="header__branding site-branding boot-col-md-6 boot-col-3 boot-order-md-2 boot-order-2 boot-text-center">
                    <?php um_theme_header_logo();?>
                </div>

                <div class="header__user-account <?php echo $position_class;?> boot-col-md-3 boot-col-6 boot-order-md-3 boot-order-3 boot-text-right">
                    <?php
                        do_action( 'um_theme_header_profile_before' );
                ...
                <div class="header__navigation boot-col-md-12 boot-col-3 boot-order-md-4 boot-order-1">
                    <?php um_theme_header_menu();?>
                </div>
            <?php endif;?>

            <?php if ( 4 === (int) $header_layout ) : ?>
                ...
                <div class="header__user-account <?php echo $position_class;?> boot-col-md-3 boot-col-6 boot-order-3 boot-order-md-3 boot-text-right">
                    <?php
                        do_action( 'um_theme_header_profile_before' );
...
if ( ! function_exists( 'um_theme_display_header_search' ) ) {
    function um_theme_display_header_search() {
        ...
        if ( 2 === (int) $show_header_search && is_user_logged_in() ) : ?>
            <div class="header-search">
                <?php um_theme_header_search_type(); ?>
            </div>
        <?php endif;
...
if ( ! function_exists( 'um_theme_header_logeed_out_components' ) ) {
    function um_theme_header_logeed_out_components() {
        ...
        <?php
        if ( 2 === $logout_display ) : // Show Login button ?>
            <div class="um-header-nonuser-button">
            <?php
            // Button 1
            if ( ! empty( $button_one_text ) ) { ?>
    ...
    function um_theme_header_output_logeed_out_text() {
        ...
        if ( ! empty( $defaults['header_logged_out_text'] ) ) {
            ...
            if ( version_compare( get_bloginfo( 'version' ),'5.4', '<' ) ) {
                ...
                echo apply_shortcodes( wp_kses_post( $content ) );
            }
...
function um_theme_header_topbar() {
    ...
    <div class="boot-text-center">
        ...
        <?php 
            ...
            // Text
            if ( 1 === (int) $topbar_column_one_layout ) :
                um_theme_header_topbar_first_column_text();
            endif;

            // Text & Social Icons
            if ( 2 === (int) $topbar_column_one_layout ) : ?>
                <div class="boot-row">
            ...
            // Menu
            if ( 3 === (int) $topbar_column_one_layout ) : ?>
            ...
            // Menu & Social Icons
            if ( 4 === (int) $topbar_column_one_layout ) : ?>
            <div class="boot-row">
                <div class="boot-col-md-6 boot-text-left">
                <nav class="navbar navbar-expand-md navbar-light" aria-label="<?php esc_attr_e( 'Top Bar Menu', 'um-theme' ); ?>">
                    <div class="boot-container-fluid">
        ...
        // Social Icons
        if ( 5 === (int) $topbar_column_one_layout ) :
...
<div class="boot-row boot-align-items-center">
        <div class="boot-col-6">
            ...
            <?php 
            // Text
            if ( $topbar_column_one_layout === 1 ) {
                um_theme_header_topbar_first_column_text();
            }

            // Text & Social Icons 
            if ( $topbar_column_one_layout === 2 ) {
                um_theme_header_topbar_first_column_text();
                um_theme_social_menu();
            }

            // Menu
            if ( $topbar_column_one_layout === 3 ) : ?>
                  <nav class="navbar navbar-expand-md navbar-light" aria-label="<?php esc_attr_e( 'Top Bar Menu', 'um-theme' ); ?>">
                      <div class="boot-container-fluid">
                        <!-- Brand and toggle get grouped for better mobile display -->
                        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#bs-navbar-topbar" aria-controls="bs-navbar-topbar" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div class="boot-col-6 boot-text-right">
            ...
            <?php if ( $topbar_column_two_layout === 2 ) : ?>
                <!-- Text & Social Icons -->
                <?php um_theme_header_topbar_second_column_text();?>
                <?php um_theme_social_menu();
            endif;?>

            <?php if ( $topbar_column_two_layout === 3 ) : ?>
                <!-- Menu -->
                  <nav class="navbar navbar-expand-md navbar-light" aria-label="<?php esc_attr_e( 'Top Bar Menu', 'um-theme' ); ?>">
                      <div class="boot-container-fluid">
                        <!-- Brand and toggle get grouped for better mobile display -->
...
if ( ! function_exists( 'um_theme_header_bottombar' ) ) {
    ...
    if ( $defaults['um_show_bottombar'] != 2 ) : ?>
